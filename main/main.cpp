...
U8G2_SSD1306_128X64_NONAME_F_HW_I2C u8g2(U8G2_R0, /* reset=*/ U8X8_PIN_NONE, /* clock=*/ 17, /* data=*/ 16);   // ESP32 Thing, HW I2C with pin remapping
//U8G2_SSD1306_128X64_VCOMH0_F_HW_I2C u8g2(U8G2_R2, U8X8_PIN_NONE, 17, 16);
...
Stream* in[]= {&encButton,&Serial};//{&encStream,&encButton,&Serial};
chainStream<2> sencoder(in);
...
void setup() {
  ...
  //initialize bot
  setupPanoBot();
  Serial.println("Panobot initialized");
  splashscreen();
  //Serial.println("Splash initialized");
  Serial.flush();
  delay(50);
}
